...
y=np.array([0.,0.501,0.])
# el tiempo es explicito
t=0;

fv=open("pendulo_{0:02d}_{1:04d}_{2:04d}_{3:04d}.dat".format(int(c*100),int(Wf*1000),int(a*1000),int(y[1]*1000)),"w")
...
pi2=2.*np.pi
print "pendulo_{0:02d}_{1:04d}_{2:04d}_{3:04d}.dat".format(int(c*100),int(Wf*1000),int(a*1000),int(y[1]*1000)),nmax

# ciclo
while (n<nmax):
  fv.write("{0:d} {1:.5f} {2:.9f} {3:.9f}\n".format(i,t,y[1], y[2]))
  y = y+rk4(f,dt,t,y)
#   if y[1] > np.pi:
#     y[1] -= pi2
#   else:
